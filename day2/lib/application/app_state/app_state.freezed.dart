...
// main stated of the app
  ...
  @override
  String toString() {
    return 'AppState(loggedIn: $loggedIn, accessToken: $accessToken, isAppStarted: $isAppStarted, isLoading: $isLoading)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, loggedIn, accessToken, isAppStarted, isLoading);
